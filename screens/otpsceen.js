...
export default class example extends Component {
  ...
  render() {
    ...
    let headerText = `ใส่เบอร์โทรศัพท์ ${this.state.enterCode ? 'verification code' : 'ของคุณ'}`
    let buttonText = this.state.enterCode ? 'Verify confirmation code' : 'ส่งรหัสยืนยันการลงทะเบียน';
    ...
    return (
      ...
      <View style={styles.container}>
          <TextInput
              placeholder={this.state.enterCode ? '_ _ _ _ _ _' : 'kkk'}
